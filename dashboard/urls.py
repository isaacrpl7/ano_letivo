...
urlpatterns = [
    ...
    # path('escolas/editar/<int:pk>', escola.EscolaUpdate, name='escolas-update'),
    ...
    # path('turmas/editar/<str:pk>', turma.TurmaUpdate, name='turmas-update'),
    ...
    # path('disciplinas/editar/<str:pk>', disciplina.DisciplinaUpdate, name='disciplinas-update'),
    ...
    # path('professores/editar/<str:pk>', professor.ProfessorUpdate, name='professores-update'),
    ...
    # path('habilidades/editar/<str:pk>', habilidade.HabilidadeUpdate, name='habilidades-update'),
